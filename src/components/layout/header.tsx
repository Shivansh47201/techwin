    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 shadow-md bg-white">
        ...
        <div className="bg-white border-b border-gray-100">
          <div className="mx-auto max-w-[1200px] px-3 sm:px-4 py-2 sm:py-3 flex items-center gap-2 sm:gap-4">
            <button
          ...
          <div className="sm:hidden px-3 py-2 border-t border-gray-100">
            <div className="relative w-full" ref={searchContainerRef}>
              <input
                ...
                className="w-full rounded-full border border-gray-200 px-3 py-1.5 text-xs focus:outline-none focus:ring-2 focus:ring-[#3B9ACB]"
                aria-label="Search"
              />
              {showSearchDropdown && (
                <SearchDropdown
        ...
        {/* SECOND FLOOR */}
        <nav className="hidden md:block bg-[#3B9ACB] text-white border-t border-[#2B7CA8]">
          <div className="mx-auto max-w-[1200px] px-4">
                      ...
                      <NavigationMenuContent className="bg-white p-4 shadow-lg rounded-md">
                        <div className="w-[760px] max-w-full text-[#111]">
                          <div className="grid grid-cols-3 gap-6">
                            ...
                            <div>
                              <h4 className="text-sm font-semibold mb-1 text-[#3B9ACB]">
                                        ...
                                        product.slug ? (
                                          <li key={product.slug}>
                                            <Link
                                              ...
                                              className="
                  block px-2 py-1.5 rounded-md transition-all
            ...
            <div className="hidden md:flex items-center gap-3 py-1">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-white text-[#3B9ACB] rounded font-medium text-sm hover:bg-[#EAF6FC] transition-colors"
                >
                  Request Quote
                </button>
              </div>
